...
def draw(self, kind:str='volume', variable:str = 'refractive_index', has_grid:bool=False,  filename='', **kwargs):
    """_summary_
    ...
    if kind == 'volume':
        ...
        pl.set_scale(xscale=scale[0], yscale=scale[1], zscale=scale[2], reset_camera=reset_camera, render=True)
        ...
        pl.set_scale(xscale=scale[0], yscale=scale[1], zscale=scale[2], reset_camera=True, render=True)
